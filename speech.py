...
def record_audio(ask=""):
    with sr.Microphone() as source: # microphone as sourc
        ...
        try:
            ...
            engine_speak('Sorry, the service is down') # error couldnot recognize
...
def respond(voice_data):
    ...
    # 3  best friend
    if there_exists(["my best friend is ", "my bestie is "]):
        bestfriendname=voice_data.split("is")[-1].strip()
        engine_speak("okay, i will remember that ")
        bestie_object.setName(bestfriendname)
        '''if bestie_object.name:
            engine_speak(f"my best friend is 
        else :
            engine_speak("you didn't said me  who is your best friend ")'''
    if there_exists(["who is my best friend","tell me who is my best friend","can you say who is my best  friend"]):

        if bestie_object.name:
            engine_speak(f"you said your  best friend is {bestie_object.name}")
        else :
            engine_speak("you didn't said me  who is your best friend ")
